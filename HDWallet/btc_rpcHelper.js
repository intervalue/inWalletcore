...
function getUnspentByThird (address, callback){
    var url = "http://13.125.253.106:3002/insight-api/addrs/" + address +"/utxo";
    var options = {
        method: 'get',
        url: url,
        headers: {
...
function getTransactions(address, callbackFun, rescan, now){
    ...
    getIndex('BTC*' + address, function(err, page, pageNum){
        if (pageNum - page > 50)
            pageNum = page + 50;
        var url = "http://13.125.253.106:3002/insight-api/addrs/" + address +"/txs?from=" + page + "&to=" + pageNum;
        var options = {
            method: 'get',
            url: url,
            headers: {
...
function importMyAddress(address, callbackFun){
    var url = "http://13.125.253.106:3002/insight-api/addrs/" + address +"/txs?from=0&to=1";
    var options = {
        method: 'get',
        url: url,
        headers: {
    ...
    request(options, function (err, res, body) {
        if (err) {
            ...
            var url2 = "http://13.125.253.106:3002/insight-api/addrs/" + address +"/txs?from=" + (num - 1) + "&to=" + num;
            var options2 = {
                method: 'get',
                url: url2,
                headers: {
